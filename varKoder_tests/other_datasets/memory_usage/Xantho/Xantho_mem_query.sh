...
varKoder image --kmer-mapping cgr -k 7 -o cgr_unknown_Xantho_attempt2 Xantho_unknown.csv -v
varKoder image --kmer-mapping cgr -k 7 -o cgr_unknown_Xantho_38 Xantho_unknown1.csv -v
