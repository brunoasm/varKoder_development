...
N_families = plot_Nsamples_area(n_samples_SRA, title = 'Eukaryotic families') + facet_wrap(~validation_set) + theme(axis.title.x = element_blank(),text = element_text(size=8))

p = plot_grid(N_species, N_genera, N_families, nrow = 1)
